  ...
  return (
    <article className='prose prose-lg max-w-4xl mx-auto'>
      ...
      <section className='mb-12'>
        ...
        <p className='mb-6'>
          The internet is shifting. Google AI Overview, ChatGPT, and Perplexity are becoming the new front
          page—replacing the traditional link-based SEO playbook with AI-generated answers. We believe this creates a
          massive opportunity for brands who adapt early.
        </p>
      </section>
      ...
      <section className='mb-12'>
        ...
        <p className='bg-gray-50 p-6 rounded-lg'>
          ...
          <span className='font-bold'> 50% traffic increase in just 30 days</span>, and our solution is already
          generating
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div className='bg-white p-6 rounded-lg shadow-sm'>
            ...
            <p>
              ...
              Robinhood. He founded and scaled{' '}
              <a
              ...
              , an AI video platform that became profitable and doubled organic traffic after deploying GEO. He writes
              most of our code and leads product and automation.
            </p>
          </div>
          ...
          <div className='bg-white p-6 rounded-lg shadow-sm'>
            ...
            <h3 className='text-2xl font-bold mb-2'>
              <a
                href='https://www.linkedin.com/in/yitongjiao/'
                target='_blank'
                rel='noopener'
                className='text-primary hover:text-primary/80'
              >
            ...
            <p>
              ...
              40+ DTC brands. She's the founder of{' '}
